...
const moveconst timeValue = document.getElementById("time");
const startButton = document.getElementById("start");
const stopButton = document.getElementById("stop");
const gameContainer = document.querySelector(".game-container");
constconst moves = document.getElementById("moves-count");
...
// Items array
const items = [
  { name: "PADMASANA", image: "PADMASANA.jpg" },
  { name: "MAKARASANA", image: "MAKARASANA.jpg" },
  { name: "BALASANA", image: "BALASANA.jpg" },
  { name: "SIMHASANA", image: "SIMHASANA.jpg" },
  { name: "VAJRASANA", image: "VAJRASANA.jpg" },
  { name: "PARVATASANA", image: "PARVATASANA.jpg" },
  { name: "CHAKRASANA", image: "CHAKRASANA.jpg" },
  { name: "CAT_POSE", image: "CAT_POSE.jpg" },
  { name: "MANDUKASANA", image: "MANDUKASANA.jpg" },
];
